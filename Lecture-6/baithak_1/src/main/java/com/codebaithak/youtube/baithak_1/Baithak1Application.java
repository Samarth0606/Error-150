...
public class Baithak1Application implements CommandLineRunner {

	//1.here we can use static objects only - else call object to use it
	public static void main(String[] args) {
		SpringApplication.run(Baithak1Application.class, args);
	}
...
// 9. since our application is dependant on bean we need to create constructor, make sure argument ho
	...
	public Baithak1Application(PaymentSerivice paymentService) {
